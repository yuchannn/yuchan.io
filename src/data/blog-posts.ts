...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      <div class="text-foreground space-y-6">
        ...
        <p>This clip starts off with Louis informing Mike of his upcoming "Rookie Dinner" in which each rookie has to host a dinner. Just as Mike brushes it off as just something that "needs to be done," and is prepared to not give it much thought, Harvey comes in with a very insightful piece of advice.</p>

        <blockquote class="border-l-4 border-foreground/20 pl-4 italic">
        ...
        <p>While I'm sure many people understand what Harvey means, I believe we can extract a lot more value from this scene by extrapolating it onto different scenarios in our lives. However, reading into it more in-depthly, I think that part of what Harvey says implies the need to take that extra mile to deliver something exceptional. Through the spectacles of the Pareto Principle, we can usually achieve 80% of something by using 20% effort. Yet, the last 20% requires 80% of your effort. The Pareto Principle urges people to prioritize the low hanging yet more rewarding fruit. However, I believe that while the Pareto Principle is applicable in some aspects of life, the last 20% is what really makes one exceptional. Focus on that 20%!</p>

        <p>In practice, this could mean taking the extra mile to write extensive unit tests to ensure your code is resilient to bugs, or perhaps bringing flowers to your next first date.</p>
      </div>
    `,
    date: '2024-10-30',
