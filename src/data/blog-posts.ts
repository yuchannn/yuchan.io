...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      <div class="prose prose-invert max-w-none">
        ...
        <p class="text-foreground/90">While I'm sure many people understand what Harvey means, I believe we can extract a lot more value from this scene by extrapolating it onto different scenarios in our lives. However, reading into it more in-depthly, I think that part of what Harvey says implies the need to take that extra mile to deliver something exceptional. Through the spectacles of the Pareto Principle, we can usually achieve 80% of something by using 20% effort. Yet, the last 20% requires 80% of your effort. The Pareto Principle urges people to prioritize the low hanging yet more rewarding fruit. However, I believe that while the Pareto Principle is applicable in some aspects of life, the last 20% is what really makes one exceptional. Focus on that 20%!</p>

        <p class="text-foreground/90">In practice, this could mean taking the extra mile to write extensive unit tests to ensure your code is resilient to bugs, or perhaps bringing flowers to your next first date.</p>
      </div>
    `,
    date: '2024-10-30',
